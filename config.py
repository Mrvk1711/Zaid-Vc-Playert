...
THUMB_URL = os.environ.get("THUMB_URL", "https://te.legra.ph/file/1b091bed5420089b363cf.jpg")
ZAID_QUE = os.environ.get("ZAID_QUE", "https://te.legra.ph/file/559d6435fa72ac95331f9.jpg")
UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "Maxopeditz")
ZAID_SUPPORT = os.environ.get("ZAID_SUPPORT", "Terayaarhoomai")
...
UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/mrvk1703/Zaid-Vc-Player")
U_BRANCH = "master"
